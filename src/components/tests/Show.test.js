  ...
  seasons: [
    {
      ...
      episodes: [
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855789.jpg",
          summary:
            "Jim realizes that the government is covering something up about Will's death and begins a personal investigation. Meanwhile, Nancy discovers that Jonathan has information about Barbara's disappearance, while Mike and his friends smuggle Jane into the school so she can use the ham radio to contact Will.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855790.jpg",
          summary:
            "Jim searches for Will at Hawkins Laboratory, but finds something unexpected. Meanwhile, Lonnie helps Joyce bury Will but reveals an ulterior motive for returning to town, while the boys find a way to locate Will but discover that Jane is opposing them.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855791.jpg",
          summary:
            "Jonathan manages to pull Nancy back to the real world from the Upside Down. Meanwhile, Lucas refuses to help with the search for Jane and goes to Hawkins Labs on his own, while Dustin and Mike look for the missing girl.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855792.jpg",
          summary:
            "Jim manages to bring everyone together so that they can join forces to reconnect Jane to the Upside Down and find Will. Meanwhile, the government closes in on Jane and the boys.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855793.jpg",
          summary:
    ...
    },
    {
      ...
      episodes: [
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855795.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/399/998468.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/399/998469.jpg",
          summary:
            "After his encounter with the shadow creature, Will's condition worsens. Meanwhile, Jim and El fight after Jim discovers that El disobeyed the rules, and Owens brings Nancy and Jonathan to Hawkins Labs for a chat.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/342/855799.jpg",
          summary:
            "Jim is trapped in the Upside Down, and Joyce enlists Bob to help find him. Meanwhile, Nancy and Jonathan go to Murray, and El learns about the circumstances surrounding her birth.",
          _links: {
            self: {
        ...
        },
        {
          ...
          summary:
            "Owens and his team try to find a way to end the shadow creature's influence on Will. Meanwhile, Dustin and Lucas find unlikely allies in their quest to find Dart.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/399/998471.jpg",
          summary:
            "El travels to Chicago to find her sister Eight, aka Kali, who has teamed up with other outcasts to kill the men who tormented her at Hawkins Labs.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/399/998472.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/399/998473.jpg",
          summary:
            "The group splits up to close the gate, evict the Mind Flayer from Will, and drive the demo-dogs away from Hawkins Lab.",
          _links: {
            self: {
      ...
      episodes: [
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510098.jpg",
          summary:
            "Things change over the summer: Jonathan, Nancy, Steve, and Billy get jobs; Dustin goes to science camp; El and Mike become an item; Lucas and Max almost become an item. Meanwhile, mysterious power outages plague Hawkins and rats start exploding.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510099.jpg",
          summary:
            "While El and Max go shopping, Nancy and Wheeler follow up on the exploding rats. Billy takes a coworker on a field trip, and Joyce blows off dinner with Jim to meet with Mr. Clarke.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510100.jpg",
          summary:
            "El goes astrally projecting and discovers that Billy has done something with Heather. While the girls try to find the missing lifeguard, Will tries to get Mike and Lucas interested in D&amp;D. Dustin and Steve spy on the mall shops, and Robin tries to decipher the Russian message.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/399/998477.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510102.jpg",
          summary:
            "The Scoop Group explore the tunnels beneath Starcourt, while Nancy and Jonathan recruit Mike and the others to help them discover what happen to the Holloways and find the Mind Flayer's base of operations.",
          _links: {
            self: {
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510103.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510104.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/204/510105.jpg",
          summary:
      ...
      episodes: [
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1026083.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1025650.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1026085.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1025655.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1026087.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1025840.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/410/1025841.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/414/1036274.jpg",
          summary:
        ...
        },
        {
          ...
          image:
            "https://static.tvmaze.com/uploads/images/medium_landscape/414/1036275.jpg",
          summary:
    ...
    },
    {
      ...
      episodes: [
        {
          id: 2427134,
          url: "https://www.tvmaze.com/episodes/2427134/stranger-things-5x01-chapter-one-the-crawl",
...
test("renders without errors", () => {
  render(
    <Show show={exampleShowData} selectedSeason={"none"} handleSelect={null} />
  );
  let showContainer = screen.getByTestId("show-container");
  expect(showContainer).toBeInTheDocument();
});

test("renders Loading component when prop show is null", () => {
  render(<Show show={null} selectedSeason={"none"} handleSelect={null} />);
  let loading = screen.getByTestId("loading-container");
...
test("renders same number of options seasons are passed in", () => {
  ...
  let seasons = screen.getAllByTestId("season-option");
  expect(seasons).toHaveLength(exampleShowData.seasons.length);
});

test("handleSelect is called when an season is selected", () => {
  let mockHandleSelect = jest.fn();
  render(
    <Show
  ...
  let seasons = screen.getByRole("combobox");
  fireEvent.change(seasons, { target: { value: "0" } });
  let season = screen.getByText("Season 1");
...
test("component renders when no seasons are selected and when rerenders with a season passed in", () => {
  ...
  let season = screen.getAllByTestId("season-option")[0];
  expect(seasons).toBeInTheDocument();
  expect(show).toBeInTheDocument();
  expect(season).toBeInTheDocument();

  rerender(
    <Show show={exampleShowData} selectedSeason={"0"} handleSelect={null} />
  );
  seasons = screen.getByRole("combobox");
  show = screen.getByTestId("show-container");
  let summary = screen.getAllByTestId("summary")[0];
  expect(seasons).toBeInTheDocument();
  expect(show).toBeInTheDocument();
